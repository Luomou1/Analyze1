...
PROFILE_YLABELS = {
    ...
    "high2g_raw": "相位差 (cycles)",
    "high2g_final": "相位差 (cycles)",
}
...
class FringeProfileWindow(QMainWindow):
    ...
    def _build_ui(self) -> None:
        ...
        self._diagnostic_axes = {
            "high2g_raw": self.diagnostic_figure.add_subplot(diagnostic_gridspec[0, 0]),
            "high2g_final": self.diagnostic_figure.add_subplot(diagnostic_gridspec[0, 1]),
        ...
        self._multi_profile_axes = {
            ...
            ("high2g_raw", "x"): self.multi_profile_figure.add_subplot(multi_profile_gridspec[2, 0]),
            ("high2g_raw", "y"): self.multi_profile_figure.add_subplot(multi_profile_gridspec[2, 1]),
            ("high2g_final", "x"): self.multi_profile_figure.add_subplot(multi_profile_gridspec[3, 0]),
            ("high2g_final", "y"): self.multi_profile_figure.add_subplot(multi_profile_gridspec[3, 1]),
        }
    ...
    def update_profiles(
        ...
        summary_parts = [
            self._draw_diagnostic_map("high2g_raw", "high2g_raw", diagnostic_maps, x=x, y=y, patch_radius=10),
            self._draw_diagnostic_map("high2g_final", "high2g_final", diagnostic_maps, x=x, y=y, patch_radius=10),
        ...
        multi_profile_summary = [
            ...
            self._draw_map_profile("high2g_raw", "x", "high2g_raw", diagnostic_maps, x=x, y=y, color="#1f77b4"),
            self._draw_map_profile("high2g_raw", "y", "high2g_raw", diagnostic_maps, x=x, y=y, color="#1f77b4"),
